    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php echo base_url('Controller_Purchased/create') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="product_name" name="name" placeholder="Enter product name" autocomplete="off"/>
                </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#addPurchasedNav").addClass('active');
