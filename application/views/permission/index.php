    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <!-- Only view and update permission allowed. No create/delete. -->
                    ...
                    <?php foreach ($groups_data as $k => $v): ?>
                      <tr>
                        <td><?php echo $v['group_name']; ?></td>
                          <td>
    <?php 
      $perms = unserialize($v['permission']);
      echo implode(', ', $perms);
    ?>
  </td>
                            ...
                            <div class="modal-dialog modal-sm">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <p>This will permanently delete the permission group <strong><?php echo $v['group_name']; ?></strong>.</p>
                                </div>
