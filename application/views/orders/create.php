          ...
          <form role="form" action="<?php base_url('Controller_Orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-7 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    <label for="customer_select">Customer Name</label>
                    <select class="form-control" id="customer_select" name="customer_id">
                      <option value="">Select Customer</option>
                      <?php foreach ($customers as $customer): ?>
                        <option value="<?php echo isset($customer['id']) ? $customer['id'] : ''; ?>"
                          data-name="<?php echo isset($customer['name']) ? htmlspecialchars($customer['name']) : (isset($customer['customer_name']) ? htmlspecialchars($customer['customer_name']) : ''); ?>"
                          data-phone="<?php echo isset($customer['phone']) ? htmlspecialchars($customer['phone']) : ''; ?>"
                          data-address="<?php echo isset($customer['address']) ? htmlspecialchars($customer['address']) : ''; ?>">
                          <?php echo isset($customer['name']) ? htmlspecialchars($customer['name']) : (isset($customer['customer_name']) ? htmlspecialchars($customer['customer_name']) : 'Unknown'); ?>
                        </option>
                      <?php endforeach; ?>
                    </select>
                  </div>
